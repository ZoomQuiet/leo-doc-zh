...
$(document).ready(function(){
    ...
    $("a.email_link").hover(function(){
        if ($(this).attr("href") == null||$(this).attr("href") == '') {
            ...
            $(this).attr("href", "https://bitbucket.org/ZoomQuiet/obp.leo-doc-zh/issues/new");
            //$(this).attr("href", "http://code.google.com/p/openbookproject/issues/entry?template=User%20defect%20report&summary={RwPyL}"+encodeURIComponent(sub)+"+"+encodeURIComponent(body));
